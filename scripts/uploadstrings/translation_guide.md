...
<img width="725" height="86" alt="Image" src="https://github.com/user-attachments/assets/c4f84a6d-8551-46c3-ba3b-fca29ed04dfa" />
...
1. Compress your `.xcloc` files using the `Compress Translations.app` which you will find next to the `.xcloc` files.
