...
def main():
    ...
    xcstrings_paths = mflocales.find_exported_xcstrings_files(target_repo)
    ...
    # Log
    print(f'compile_website_strings: Loaded vue .xcstrings files at {xcstrings_paths}')
