...
- [x] Insert key in source file
    - Test both IB and code source file (insert in code using MFLocalizedString)
...
def update_strings_files(files, type, repo_root):
    ...
    - On location of English (development language) UI strings:
        ...
        - Maybe we should've specified development language values directly in the source code using `MFLocalizedStringWithDefaultValue` instead of inside en.lproj. That way we wouldn't need en.lproj at all.
