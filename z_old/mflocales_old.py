"""
Utils for facilitating old localization code, which we used before moving to .xcstrings
"""
...
def get_diff_string(str1, str2, filter_unchanged_lines=True, filter_identical_files=True, show_line_numbers=True):
    ...
    """
    Creates a git-style diff string to show the difference between two strings `str1` and `str2`
    """
